...
| 006 | [006_Worker_Resource_Separation_and_Parallel_Processing_Strategy.md](./006_Worker_Resource_Separation_and_Parallel_Processing_Strategy.md) | Proposed | GPU/CPU Worker 분리, Task Queue, 병렬 처리 전략 |
